...
The `v0.4.8` development release provides all four requested desktop packages:

| Platform | Package | Intended system |
|---|---|---|
| macOS | [Apple Silicon DMG](https://github.com/DRAZY/Audio-V/releases/download/v0.4.8/Audio-V-0.4.8-mac-arm64.dmg) | Native Apple Silicon |
| macOS | [Universal DMG](https://github.com/DRAZY/Audio-V/releases/download/v0.4.8/Audio-V-0.4.8-mac-universal.dmg) | Apple Silicon and Intel |
| Windows | [x64 installer](https://github.com/DRAZY/Audio-V/releases/download/v0.4.8/Audio-V-0.4.8-win-x64.exe) | Guided desktop installation |
| Windows | [x64 portable](https://github.com/DRAZY/Audio-V/releases/download/v0.4.8/Audio-V-Portable-0.4.8-x64.exe) | Run without installing the application |
