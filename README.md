<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/DRAZY/Audio-V/releases/tag/v0.4.14"><img alt="Latest development release 0.4.14" src="https://img.shields.io/badge/latest-0.4.14-8b5cf6?style=for-the-badge"></a>
...
The latest development release is **[Audio-V 0.4.14](https://github.com/DRAZY/Audio-V/releases/tag/v0.4.14)**. It contains the complete locally built asset set:

| Platform | Download | Intended system |
|---|---|---|
| macOS | [Apple Silicon DMG](https://github.com/DRAZY/Audio-V/releases/download/v0.4.14/Audio-V-0.4.14-mac-arm64.dmg) | Native Apple Silicon |
| macOS | [Universal DMG](https://github.com/DRAZY/Audio-V/releases/download/v0.4.14/Audio-V-0.4.14-mac-universal.dmg) | Apple Silicon and Intel |
| Windows | [Windows installer](https://github.com/DRAZY/Audio-V/releases/download/v0.4.14/Audio-V-0.4.14-win-x64.exe) | Guided desktop installation |
| Windows | [Portable executable](https://github.com/DRAZY/Audio-V/releases/download/v0.4.14/Audio-V-Portable-0.4.14-x64.exe) | Run without installation |

The same version-named GitHub Release exposes block maps, [`SHA256SUMS.txt`](https://github.com/DRAZY/Audio-V/releases/download/v0.4.14/SHA256SUMS.txt), and [`UNSIGNED_RELEASE_MANIFEST.json`](https://github.com/DRAZY/Audio-V/releases/download/v0.4.14/UNSIGNED_RELEASE_MANIFEST.json). Read the [release workflow](docs/RELEASING.md) and [unsigned installation guide](docs/UNSIGNED_INSTALLATION.md) before opening an unsigned build.
