...
As of source version 0.4.32:

| Area | Current evidence | RC meaning |
|---|---|---|
| Source regression | 150 tests passed | Automated source behavior is green |
...
| Release assets | Four v0.4.32 application packages, checksums, block maps, and unsigned policy manifest prepared and verified locally | Preview distribution is ready for publication |
