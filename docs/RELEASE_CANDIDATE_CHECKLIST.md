...
| Release assets | Four v0.4.34 application packages, checksums, block maps, and unsigned policy manifest were prepared, verified, and published | Current release distribution is complete |
